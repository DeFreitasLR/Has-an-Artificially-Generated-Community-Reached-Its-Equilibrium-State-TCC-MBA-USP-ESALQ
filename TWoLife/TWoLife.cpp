                         ...
                         char ** outCode)
{
    ...
    while (floresta->tempo_do_mundo < tempo[0] && floresta->conta_individuos() > 0 && floresta->conta_individuos() < 1000000) // Performs the simulation until the maximum desired time is reached
    {
